...
const About = () => {
  ...
  return (
    <>
      <div className="flex flex-col md:flex-row justify-between items-center pt-10 pb-15 gap-2">
        <div className="w-1/2 flex flex-col items-start justify-start gap-3">
          ...
          <p className="text-gray-400 text-lg flex text-start">
            Vi är ett passionerat team av utvecklare och designers som drivs av
            en gemensam vision: att bygga enkla, kraftfulla och vackra
            webbupplevelser.
          </p>
      ...
      <div className="pt-10 flex items-start flex-col">
        ...
        <p className="text-lg text-gray-400 pt-5 w-2/3">
          ...
          partnerskap, inte bara projekt. Vårt arbetssätt grundar sig i dessa
          kärnvärden.
        </p>
      ...
      <div className="bg-theme-charcoalBlue text-theme-white flex flex-col justify-center items-center rounded-xl mt-20 py-6 px-4">
        ...
        />
        <UiSmallText textContent="Har du en idé du vill förverkliga? Vi är redo att hjälpa dig att ta nästa steg. Kontakta oss för ett förutsättningsläst samtal." />
